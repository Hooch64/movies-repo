...
<form class="container mt-5" style="max-width: 800px;" method="post" action="https://movies.test/admin/categories/editer">
    ...
    <div class="row">
        <div class="form-group">
            ...
            <input type="text" class="form-control <?= htmlspecialchars($errorMessage['class'], ENT_QUOTES, 'UTF-8'); ?> mt-2" id="category" name="category" value="<?= htmlspecialchars(getValue('category'), ENT_QUOTES, 'UTF-8'); ?>">
            <?= htmlspecialchars($errorMessage['message'], ENT_QUOTES, 'UTF-8'); ?>
        </div>
